...
public class Game {
    ...
    private static ArrayList<Integer> deck = new ArrayList<>(DECK_SIZE);
    ...
    public static void playTurn(int player, Scanner input, boolean deckEmpty) {
        String decision;
    ...
    public static void main(String[] args) {
        ...
        while (gameOver() == 0) {
            playTurn(1, input, !(deck.size() > 0));
            playTurn(2, input, !(deck.size() > 0));
        }
